...
ax1.axis([-108,-92,23,39], aspect='equal')
ax1.set_aspect('equal')
ax2.axis([0,12000,0,1])
...
texas = curve_utils.curve_from_shapefile(os.path.join('shapefiles','Texas outline','Texas_State_Boundary.shp'), tolerance=0)
...
anim = animation.FuncAnimation(fig, animate, init_func=init,
                               frames=12000, interval=1, blit=True)
